...
const CHANNEL_TYPES = ["telegram", "discord", "slack", "whatsapp", "zalo_oa", "zalo_personal", "feishu", "max"];
const PERM_CHANNELS = ["telegram", "discord", "zalo", "slack", "feishu", "max"] as const;
