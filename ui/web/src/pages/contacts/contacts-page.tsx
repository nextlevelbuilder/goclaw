...
const CHANNEL_TYPES = ["telegram", "discord", "slack", "whatsapp", "zalo_oa", "zalo_personal", "feishu", "bitrix24", "dingtalk"];
const PERM_CHANNELS = ["telegram", "discord", "zalo", "slack", "feishu", "bitrix24", "dingtalk"] as const;
