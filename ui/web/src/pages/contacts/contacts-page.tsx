...
const CHANNEL_TYPES = ["telegram", "discord", "slack", "whatsapp", "zalo_oa", "zalo_personal", "feishu", "bitrix24", "max"];
const PERM_CHANNELS = ["telegram", "discord", "zalo", "slack", "feishu", "bitrix24", "max"] as const;
