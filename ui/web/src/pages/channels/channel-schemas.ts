...
export const configSchema: Record<string, FieldDef[]> = {
  ...
  dingtalk: [
    ...
    { key: "card_update_interval_ms", label: "Card Repaint Interval (ms)", type: "number", defaultValue: 800, help: "One billed card API call per repaint. The DingTalk client animates between frames, so raising this cuts cost without making the typing look chunky. Minimum 100.", advanced: true },
