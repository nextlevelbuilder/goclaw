...
// WorkflowAction is one of the supported recovery transitions. The
...
// AllWorkflowActions is the canonical, ordered set of supported actions.
...
func (a WorkflowAction) Valid() bool {
	switch a {
	case WorkflowActionRetryBlocked, WorkflowActionCancelWorkflow,
		WorkflowActionFailWorkflow, WorkflowActionRetryExpansion,
		WorkflowActionRetryDelivery:
		return true
	}
	return false
...
func (a WorkflowAction) StepScoped() bool {
	switch a {
	case WorkflowActionRetryBlocked:
		return true
	}
	return false
}
