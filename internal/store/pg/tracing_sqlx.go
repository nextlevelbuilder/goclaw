...
type traceRow struct {
	...
	ParentTraceID     *uuid.UUID      `json:"parent_trace_id"`
	...
	TotalCost         float64         `json:"total_cost"` // COALESCE in SQL guarantees non-NULL
...
type spanRow struct {
	...
	ParentSpanID  *uuid.UUID      `json:"parent_span_id"`
	AgentID       *uuid.UUID      `json:"agent_id"`
