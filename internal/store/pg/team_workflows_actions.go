...
// transition for the five operator/coordinator recovery actions
// (retry_blocked, cancel_workflow, fail_workflow, retry_expansion,
// retry_delivery). Every branch here opens one transaction, locks the authoritative
