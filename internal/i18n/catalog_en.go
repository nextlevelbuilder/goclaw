...
func init() {
	register(LocaleEN, map[string]string{
		...
		MsgMeowNotAuthorized:  "❌ Not authorized. Owner-gated — run /meow verify from the configured owner chat first.",
		MsgMeowOpsUnavailable: "Meow content commands are not wired on this instance.",
		MsgMeowBadDate:        "Bad date %q (want YYYY-MM-DD).",
		MsgMeowChannelUnknown: "Unknown channel %s.",
		MsgMeowError:          "Error: %s",
		MsgMeowQueueUsage:     "Usage: /meow queue <@handle>",
		MsgMeowQueueEmpty:     "No draft or approved posts for %s.",
		MsgMeowQueueHeader:    "📋 Queue for %s:",
		MsgMeowPreviewUsage:   "Usage: /meow preview <@handle> <YYYY-MM-DD>",
		MsgMeowPostNone:       "No post for %s on %s.",
		MsgMeowApproveUsage:   "Usage: /meow approve <@handle> <YYYY-MM-DD>",
		MsgMeowApproved:       "✅ Approved %s for %s.",
		MsgMeowNoDraftToAct:   "No draft for %s on %s.",
		MsgMeowSkipUsage:      "Usage: /meow skip <@handle> <YYYY-MM-DD>",
		MsgMeowSkipped:        "✅ Skipped %s for %s.",
		MsgMeowNoPostToSkip:   "No draft or approved post for %s on %s.",
		MsgMeowEditUsage:      "Usage: /meow edit <@handle> <YYYY-MM-DD> ko|en <text>",
		MsgMeowEditBadField:   "Field must be 'ko' or 'en' (got %q).",
		MsgMeowEdited:         "✅ Updated %s text for %s on %s.",
		MsgMeowIngestUsage:    "Usage: /meow ingest <bundle.json under the inbox>",
		MsgMeowIngestHeld:     "⚠️ Held (not ingested): %s",
		MsgMeowIngested:       "✅ Ingested draft for %s on %s.",
	})
}
