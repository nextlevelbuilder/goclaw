...
func init() {
	register(LocaleVI, map[string]string{
		...
		MsgMeowNotAuthorized:  "❌ Không có quyền. Chỉ chủ sở hữu — hãy chạy /meow verify từ chat chủ sở hữu đã cấu hình trước.",
		MsgMeowOpsUnavailable: "Các lệnh nội dung Meow chưa được kích hoạt trên phiên bản này.",
		MsgMeowBadDate:        "Ngày không hợp lệ %q (cần YYYY-MM-DD).",
		MsgMeowChannelUnknown: "Kênh không xác định %s.",
		MsgMeowError:          "Lỗi: %s",
		MsgMeowQueueUsage:     "Cách dùng: /meow queue <@handle>",
		MsgMeowQueueEmpty:     "Không có bài nháp hoặc đã duyệt cho %s.",
		MsgMeowQueueHeader:    "📋 Hàng đợi cho %s:",
		MsgMeowPreviewUsage:   "Cách dùng: /meow preview <@handle> <YYYY-MM-DD>",
		MsgMeowPostNone:       "Không có bài cho %s vào %s.",
		MsgMeowApproveUsage:   "Cách dùng: /meow approve <@handle> <YYYY-MM-DD>",
		MsgMeowApproved:       "✅ Đã duyệt %s cho %s.",
		MsgMeowNoDraftToAct:   "Không có bài nháp cho %s vào %s.",
		MsgMeowSkipUsage:      "Cách dùng: /meow skip <@handle> <YYYY-MM-DD>",
		MsgMeowSkipped:        "✅ Đã bỏ qua %s cho %s.",
		MsgMeowNoPostToSkip:   "Không có bài nháp hoặc đã duyệt cho %s vào %s.",
		MsgMeowEditUsage:      "Cách dùng: /meow edit <@handle> <YYYY-MM-DD> ko|en <nội dung>",
		MsgMeowEditBadField:   "Trường phải là 'ko' hoặc 'en' (nhận được %q).",
		MsgMeowEdited:         "✅ Đã cập nhật nội dung %s cho %s vào %s.",
		MsgMeowIngestUsage:    "Cách dùng: /meow ingest <bundle.json trong hộp thư inbox>",
		MsgMeowIngestHeld:     "⚠️ Đã giữ lại (chưa nhập): %s",
		MsgMeowIngested:       "✅ Đã nhập bài nháp cho %s vào %s.",
	})
}
