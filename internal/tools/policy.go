...
var builtinToolGroups = map[string][]string{
	...
	"ui":         {"browser"},
	"automation": {"cron"},
	"messaging":  {"message", "create_forum_topic", "list_group_members", "create_discord_thread", "send_discord_embed"},
	"team":       {"team_tasks"},
	...
	"goclaw": {
		...
		"message", "create_forum_topic", "list_group_members", "create_discord_thread", "send_discord_embed",
