-- Reverse of 000098_team_work_enforcement.up.sql.
--
...
BEGIN
    IF EXISTS (
        ...
        RAISE EXCEPTION 'cannot roll back team work enforcement: v98-only workflow state exists';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE EXCEPTION 'cannot roll back team work enforcement: v98-only task state exists';
    END IF;
